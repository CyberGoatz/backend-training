...
/**
 * Encapsulates information about training level. Inherits from {@link
 * AbstractLevelVisualizationDTO} Used for visualization.
 */
@Getter
@Setter
@ToString
@NoArgsConstructor
@ApiModel(
    value = "TrainingLevelVisualizationDTO",
    description = "Information about training level needed for visualizations.",
