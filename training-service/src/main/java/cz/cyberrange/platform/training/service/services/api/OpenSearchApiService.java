...
public class OpenSearchApiService {
    ...
    private WebClient opensearchServiceWebClient;

    /**
     * Instantiates a new OpenSearchApi service.
     *
     * @param opensearchServiceWebClient the web client
     */
    public OpenSearchApiService(@Qualifier("opensearchServiceWebClient") WebClient opensearchServiceWebClient) {
        this.opensearchServiceWebClient = opensearchServiceWebClient;
    }

    /**
     * Deletes events from opensearch for particular training instance
     *
     * @param trainingInstanceId id of the training instance whose events to delete.
     * @throws MicroserviceApiException error with specific message when calling opensearch microservice.
     */
    public void deleteEventsByTrainingInstanceId(Long trainingInstanceId){
        try {
            opensearchServiceWebClient
                    .delete()
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete events for particular instance (ID: "+ trainingInstanceId +").", ex);
        }
    }

    /**
     * Obtain events from opensearch for particular training definition
     *
    ...
    public List<AbstractAuditPOJO> findAllEventsFromTrainingDefinition(Long trainingDefinitionId){
        try {
            return opensearchServiceWebClient
                    .get()
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular definition (ID: "+ trainingDefinitionId +").", ex);
        }
    }

    /**
     * Obtain events from opensearch for particular training instance
     *
    ...
    public List<AbstractAuditPOJO> findAllEventsFromTrainingInstance(TrainingInstance trainingInstance){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular instance (ID: "+ trainingInstance.getId() +").", ex);
        }
    }


    /**
     * Obtain events from opensearch for particular training run
     *
    ...
    public List<AbstractAuditPOJO> findAllEventsFromTrainingRun(TrainingRun trainingRun){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular run (ID: "+ trainingRun.getId() +").", ex);
        }
    }
    ...
    public Map<Long, Map<Long, List<AbstractAuditPOJO>>> getAggregatedEventsByLevelsAndTrainingRuns(Long instanceId) {
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular instance (ID: "+ instanceId +").", ex);
        }
    }
    ...
    /**
     * Obtain events from opensearch for particular training instance and level aggregated by users.
     *
    ...
    /**
     * Deletes events from opensearch for particular training run
     *
    ...
    public void deleteEventsFromTrainingRun(Long trainingInstanceId, Long trainingRunId){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete events for particular training run (ID: "+ trainingRunId +").", ex);
        }
    }
    ...
    public List<Map<String, Object>> findAllConsoleCommandsBySandbox(String sandboxId){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular sandbox (ID: " + sandboxId +").", ex);
        }
    }
    ...
    public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserId(String accessToken, Long userId){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular training " +
    ...
    public List<Map<String, Object>> findAllConsoleCommandsBySandboxAndTimeRange(String sandboxId, Long from, Long to, List<String> filterCommands){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular commands of sandbox (ID: " + sandboxId +").", ex);
        }
    }
    ...
    public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserIdAndTimeRange(String accessToken, Long userId, Long from, Long to){
        try {
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API for particular commands of training " +
                    "(access-token: " + accessToken +")" + "(user: " + userId +").", ex);
        }
    }
    ...
    public void deleteCommandsByPool(Long poolId){
        try{
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete bash commands for particular pool (ID: " + poolId +").", ex);
        }
    }
    ...
    public void deleteCommandsByAccessToken(String accessToken){
        try{
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete bash commands for particular training instance (access-token: " + accessToken +").", ex);
        }
    }
    ...
    public void deleteCommandsBySandbox(String sandboxId){
        try{
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete bash commands for particular sandbox (ID: " + sandboxId +").", ex);
        }
    }
    ...
    public void deleteCommandsByAccessTokenAndUserId(String accessToken, Long userId){
        try{
            ...
            throw new MicroserviceApiException("Error when calling OpenSearch API to delete bash commands for particular training (Access Token: " + accessToken +", User ID: " + userId +").", ex);
        }
    }
}
