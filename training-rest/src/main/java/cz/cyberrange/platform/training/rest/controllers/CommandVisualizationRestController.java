...
public class CommandVisualizationRestController {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(CommandVisualizationRestController.class);
  ...
  /**
   * Get aggregated correct/incorrect commands for the given training runs of the specific training
   * instance.
   *
   * @param runIds IDs of training run.
   * @return semantically and syntactically correct/incorrect commands executed during the given
   *     training runs and aggregated by tools and type. The frequency of the used tools is also
   *     included.
   */
  @ApiOperation(
      httpMethod = "GET",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Aggregated correct/incorrect commands found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message =
                "Aggregated correct/incorrect commands for the given training runs not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/commands/training-instances/{instanceId}/aggregated",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getAggregatedCommandsForOrganizer(
      ...
      @ApiParam(value = "Training Run IDs", required = true, type = "List of numbers") @RequestParam
          List<Long> runIds,
      @ApiParam(value = "If correct or incorrect commands should be returned.") @RequestParam
          boolean correct,
      @ApiParam(value = "Mistake types", type = "List of strings") @RequestParam(required = false)
          List<MistakeType> mistakeTypes) {
    return ResponseEntity.ok(
        commandVisualizationFacade.getAggregatedCommandsForOrganizer(
            instanceId, runIds, correct, mistakeTypes));
  }
   ...
   * @return semantically and syntactically correct/incorrect commands executed during the given
   *     training run and aggregated by tools and type. The frequency of the used tools is also
   *     included.
   */
  @ApiOperation(
      httpMethod = "GET",
  ...
  @GetMapping(
      path = "/commands/training-runs/{runId}/aggregated",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getAggregatedCommandsForTrainee(
      ...
      @ApiParam(value = "Mistake types", type = "List of strings") @RequestParam(required = false)
          List<MistakeType> mistakeTypes) {
    return ResponseEntity.ok(
        commandVisualizationFacade.getAggregatedCommandsForTrainee(runId, correct, mistakeTypes));
  }
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Commands for the given training run found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Commmands for the given training run not found.",
            response = ApiError.class)
      })
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Finished runs in the given training instance found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Finished runs in the given training instance not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/training-instances/{instanceId}/training-runs",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<TrainingRunDTO>> findFinishedTrainingRunsByTrainingInstanceId(
      @ApiParam(value = "Training Instance ID", required = true) @PathVariable("instanceId")
          Long instanceId) {
    List<TrainingRunDTO> trainingRuns =
        commandVisualizationFacade.findTrainingRunsByTrainingInstance(instanceId);
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "All commands for the given training instance found",
            response = Map.class),
        @ApiResponse(
            code = 404,
            message = "All commands for the given training instance not found",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/commands/training-instances/{instanceId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Map<Long, List<CommandDTO>>> getAllCommandsByTrainingInstance(
      @ApiParam(value = "Training Instance ID", required = true) @PathVariable("instanceId")
          Long instanceId) {
    return ResponseEntity.ok(
        commandVisualizationFacade.getAllCommandsByTrainingInstance(instanceId));
  }
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "All commands for the given Training Run found",
            response = List.class),
        @ApiResponse(
            code = 404,
            message = "All commands for the given Training Run not found",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/commands/training-runs/{runId}/all",
      produces = MediaType.APPLICATION_JSON_VALUE)
